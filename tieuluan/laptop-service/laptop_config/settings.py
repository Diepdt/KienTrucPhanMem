...
SECRET_KEY = os.environ.get('SECRET_KEY', 'laptop-service-secret-key')
DEBUG = True
ALLOWED_HOSTS = ['*']
...
ROOT_URLCONF = 'laptop_config.urls'
...
WSGI_APPLICATION = 'laptop_config.wsgi.application'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql',
        'NAME': os.environ.get('DB_NAME', 'db_laptop'),
